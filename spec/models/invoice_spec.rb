...
describe "final project" do
  describe "instance methods" do
    ...
    it ".merchant_invoice_discounted_revenue" do
      merchant_A = Merchant.create!(name: "Merchant A")
      merchant_B = Merchant.create!(name: "Merchant B")
      merchant_C = Merchant.create!(name: "Merchant C")
      ...
      expect(invoice_B1.merchant_invoice_discounted_revenue(merchant_A)).to eq(0.99)
      expect(invoice_A1.merchant_invoice_discounted_revenue(merchant_B)).to eq(95.0)
      expect(invoice_A2.merchant_invoice_discounted_revenue(merchant_C)).to eq(0)
    end
    ...
    it ".merchant_invoice_revenue" do
      ...
      expect(invoice_B1.merchant_invoice_revenue(merchant_A)).to eq(0.99)
      expect(invoice_A1.merchant_invoice_revenue(merchant_B)).to eq(130.0)
      expect(invoice_A2.merchant_invoice_revenue(merchant_C)).to eq(1000000.0)
    end

    it ".admin_invoice_total_revenue" do
      merchant_A = Merchant.create!(name: "Merchant A")
      merchant_B = Merchant.create!(name: "Merchant B")
      merchant_C = Merchant.create!(name: "Merchant C")
      ...
      expect(invoice_B1.admin_invoice_total_revenue).to eq(100130.99)
      expect(invoice_A1.admin_invoice_total_revenue).to eq(100130.99)
      expect(invoice_A2.admin_invoice_total_revenue).to eq(1000103.97)
    end
    ...
    it ".admin_invoice_total_revenue" do
      ...
      expect(invoice_B1.admin_invoice_discounted_revenue).to eq(95.99)
      expect(invoice_A1.admin_invoice_discounted_revenue).to eq(95.99)
      expect(invoice_A2.admin_invoice_discounted_revenue).to eq(91.0729999999702)
    end
  end
end
